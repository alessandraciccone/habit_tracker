...
from fastapi.security import OAuth2PasswordBearer, OAuth2PasswordRequestForm  # <-- AGGIUNGI QU                   from sqlalchemy.orm import Session
from jose import JWTError, jwt
from passlib.context import CryptContext
from sqlalchemy.orm import Session
from app.database import get_db  # ✅ Solo questo
